  ...
  return (
    <div>
      <div className='about' id='about-link'>
        ...
        <a id='resume' href={resume} >View My Resume Here</a>
      </div>
      ...
      <div className='skills' id='skills-link'>
        ...
        <div className='skills-div'>
          ...
          <div id='methods'>
            <h2>Methodologies</h2>
            <p>Object Oriented Programming, MVC, Test-Driven Development, Responsive Design, Authentication, Wireframing, Agile/Scrum, Troubleshooting/Debugging.</p>
          </div>
          <div id='databases'>
            <h2>Databases</h2>
